...
module.exports = function(){
    ...
    }).get('/imagecollect/guidePermission:guideAddrStatus', function*(){ //菜单权限
        var $self = this;
        var page = {name:$self.params.guideAddrStatus,userToken:$self.cookies.get('token')};
        yield (server().imagePermission(page)
            .then((parsedBody) =>{
                var responseText = JSON.parse(parsedBody);
                $self.body = responseText;
            }).catch((error) =>{
    ...
    }).get('/dispatchcarinfo/area', function*(){ //查询所有所属地区
        var $self = this;
        var page = $self.request.query;
        page.userToken = $self.cookies.get('token');
        yield (server().infoArea(page)
            .then((parsedBody) =>{
                var responseText = JSON.parse(parsedBody);
                $self.body = responseText;
            }).catch((error) =>{
    ...
    }).get('/dispatchcarinfo/department', function*(){ //查询所有项目组
        var $self = this;
        var page = $self.request.query;
        page.userToken = $self.cookies.get('token');
        yield (server().infoDepartment(page)
            .then((parsedBody) =>{
                var responseText = JSON.parse(parsedBody);
                $self.body = responseText;
            }).catch((error) =>{
    ...
    }).get('/dispatchcarinfo/balance', function*(){ //根据油卡编号查询油卡余额
        var $self = this;
        var page = $self.request.query;
        page.userToken = $self.cookies.get('token');
        yield (server().infoBalance(page)
            .then((parsedBody) =>{
                var responseText = JSON.parse(parsedBody);
                $self.body = responseText;
            }).catch((error) =>{
    ...
    }).get('/dispatchcarinfo/projectapproval', function*(){ //根据项目名称获取立项信息
        var $self = this;
        var page = $self.request.query;
        page.userToken = $self.cookies.get('token');
        yield (server().infoApproval(page)
            .then((parsedBody) =>{
                var responseText = JSON.parse(parsedBody);
                $self.body = responseText;
            }).catch((error) =>{
    ...
    }).get('/dispatchcarinfo/oilwear', function*(){ //根据司机姓名获取出车油耗
        var $self = this;
        var page = $self.request.query;
        page.userToken = $self.cookies.get('token');
        yield (server().infoOilwear(page)
            .then((parsedBody) =>{
                var responseText = JSON.parse(parsedBody);
                $self.body = responseText;
            }).catch((error) =>{
    ...
    }) .get('/imagecollect/dayCollect', function*(){//图形化日汇总
        var $self = this;
        var count = $self.request.query;
        count.userToken = $self.cookies.get('token');
    ...
    }).get('/imagecollect/monthCollect', function*(){//图形化月汇总
        var $self = this;
        var count = $self.request.query;
        count.userToken = $self.cookies.get('token');
        yield (server().monthCollect(count)
            .then((parsedBody) =>{
                var responseText = JSON.parse(parsedBody);
                $self.body = responseText;
            }).catch((error) =>{
    ...
    }).get('/imagecollect/allCollect', function*(){//图形化累计汇总
        var $self = this;
        var count = $self.request.query;
        count.userToken = $self.cookies.get('token');
        yield (server().allCollect(count)
            .then((parsedBody) =>{
                var responseText = JSON.parse(parsedBody);
                $self.body = responseText;
            }).catch((error) =>{
    ...
    }).get('/imagecollect/weekCollect', function*(){//图形化周汇总
        var $self = this;
        var count = $self.request.query;
        count.userToken = $self.cookies.get('token');
        yield (server().weekCollect(count)
            .then((parsedBody) =>{
                var responseText = JSON.parse(parsedBody);
                $self.body = responseText;
            }).catch((error) =>{
