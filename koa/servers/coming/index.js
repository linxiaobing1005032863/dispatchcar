...
//设置导航权限
    ...
    this.imagePermission = function(argvs){
        var options = {
            method : 'GET',
            timeout : 3000,
            uri : config()['rurl'] + `/imagecollect/v1/guidePermission?guideAddStatus=`+argvs.name,
            headers:{
                userToken:argvs.userToken
            }
        };
    ...
    //查询所有项目组
    this.infoDepartment = function (argvs) {
        var options = {
            method: 'GET',
            timeout: 3000,
            uri: config()['rurl'] + `/dispatchcarinfo/v1/find/department`,
            headers: {
                userToken: argvs.userToken
            }
        };
    ...
    //查询所有所属地区
    this.infoArea = function (argvs) {
        var options = {
            method: 'GET',
            timeout: 3000,
            uri: config()['rurl'] + `/dispatchcarinfo/v1/find/area`,
            headers: {
                userToken: argvs.userToken
            }
        };
    ...
    ////根据油卡编号查询油卡余额
    this.infoBalance = function (argvs) {
        var options = {
            method: 'GET',
            timeout: 3000,
            uri: config()['rurl'] + `/dispatchcarinfo/v1/find/balance${urlEncode(argvs, true)}`,
            headers: {
                userToken: argvs.userToken
            }
        };
    ...
    //根据项目名称获取立项信息
    this.infoApproval = function (argvs) {
        var options = {
            method: 'GET',
            timeout: 3000,
            uri: config()['rurl'] + `/dispatchcarinfo/v1/find/projectapproval${urlEncode(argvs, true)}`,
            headers: {
                userToken: argvs.userToken
            }
        };
    ...
    ////根据司机姓名获取出车油耗
    this.infoOilwear = function (argvs) {
        var options = {
            method: 'GET',
            timeout: 3000,
            uri: config()['rurl'] + `/dispatchcarinfo/v1/find/oilwear${urlEncode(argvs, true)}`,
            headers: {
                userToken: argvs.userToken
            }
        };
...
//日汇总
    ...
    this.dayCollect = function (argvs) {
        var options = {
            method: 'GET',
            timeout: 3000,
            uri: config()['rurl'] + `/imagecollect/v1/dayCollect${urlEncode(argvs, true)}`,
            headers: {
                userToken: argvs.userToken
            }
        };
    ...
    this.monthCollect = function (argvs) {
        var options = {
            method: 'GET',
            timeout: 3000,
            uri: config()['rurl'] + `/imagecollect/v1/monthCollect${urlEncode(argvs, true)}`,
            headers: {
                userToken: argvs.userToken
            }
        };
    ...
    //图形化累计汇总
    this.allCollect = function (argvs) {
        var options = {
            method: 'GET',
            timeout: 3000,
            uri: config()['rurl'] + `/imagecollect/v1/allCollect${urlEncode(argvs, true)}`,
            headers: {
                userToken: argvs.userToken
            }
        };
    ...
    this.weekCollect = function (argvs) {
        var options = {
            method: 'GET',
            timeout: 3000,
            uri: config()['rurl'] + `/imagecollect/v1/weekCollect${urlEncode(argvs, true)}`,
            headers: {
                userToken: argvs.userToken
            }
        };
