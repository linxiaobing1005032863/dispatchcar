...
app.controller('payprincipalsuggCtrl', function($scope, paySer,$stateParams,$state,toastr){
    ...
    $scope.count=function(){
        ...
        //根据司机姓名获取出车油耗
        paySer.Oilwear(data).then(function(response){
            if(response.data.code == 0){
    ...
    $scope.count1=function(){
        ...
        ////根据项目名称获取立项信息
        paySer.Approval().then(function(response){
            if(response.data.code == 0){
    ...
    $scope.count3=function(){
        ...
        paySer.Balance(data).then(function(response){
            if(response.data.code == 0){
    ...
    //查询所有司机信息和车牌号码
    paySer.infoDriver().then(function(response){
        if(response.data.code == 0){
    ...
    //查询所有用车陪同人员
    paySer.infoEntry().then(function(response){
        if(response.data.code == 0){
    ...
    ////查找所有项目名称
    paySer.infoProject().then(function(response){
        if(response.data.code == 0){
    ...
    //查询所有用车陪同人员
    paySer.infoOil().then(function(response){
        if(response.data.code == 0){
    ...
    $scope.infoEditFun = function() {
        ...
        var data = {
            ...
            receiver:vm.edit.receiver,
            receiveDate:vm.edit.receiveDate,
            receiveReceipts:vm.edit.receiveReceipts,
            ...
            moneyModuleIdea:vm.moneyModuleIdea,
