...
app.config(function($provide, $stateProvider){
    ...
    }).state("root.dispatchcar.waitaudit.client[12]",{
        url:"/client[12]?id=&page=",
        views:{
            "content@root.dispatchcar.waitaudit":{
                templateUrl : "root/dispatchcar/waitaudit/client/_res/html/index.html",
                controller:'waitclientCtrl'
            }
        }
    }).state("root.dispatchcar.waitaudit.head[12]",{
        url:"/head[12]?id=&page=",
        views:{
            "content@root.dispatchcar.waitaudit":{
                templateUrl : "root/dispatchcar/waitaudit/head/_res/html/index.html",
                controller:'waitheadCtrl'
            }
        }
    })
});
